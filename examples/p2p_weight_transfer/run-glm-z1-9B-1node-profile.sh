...
# Single-node profiling script for GLM-Z1-9B-0414 with p2p weight transfer.
# Disaggregated on 1 node: 4 GPUs train + 4 GPUs rollout.
#
# Usage:
#   bash run-glm-z1-9B-1node-profile.sh <MODE>
#
#   MODE : broadcast | p2p
...
run_mode() {
    ...
    # --- Training parallelism (TP=2, CP=2, 4 GPUs) ---
    PERF_ARGS=(
    ...
    # --- SGLang: 2 engines x 2 GPUs (WS=4 for 4 rollout GPUs) ---
    SGLANG_ARGS=(
...
echo ""
echo "============================================================"
echo "  Running: GLM-Z1-9B-0414 / ${MODE}"
echo "============================================================"
echo ""
