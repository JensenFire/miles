...
case "${MODEL_NAME}" in
    ...
    GLM-5)
        ...
        # Training parallelism: TP=4, PP=4, CP=2, EP=32 (from run_glm5_744b_a40b.py 16+ node)
        TP=4; PP=4; CP=2; EP=32
        DECODER_LAST_PIPELINE="--decoder-last-pipeline-num-layers 18"
